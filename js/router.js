const routes = {
  ...
  work: { title: 'Operations', page: 'pages/work.html', init: 'initWorkPage' },
  accounts: { title: 'Finance', page: 'pages/accounts.html', init: 'initAccountsPage' },
...
async function navigateTo(routeName = getCurrentRoute()) {
  ...
  if (!route.public && !role.includes('admin')) {
